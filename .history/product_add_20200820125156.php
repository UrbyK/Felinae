            ...
            <div class="card user-form">
                ...
                <div class="card-body">
                    <form method="post" class="content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-md-4 col-form-label text-md-left" for="publishedAt">Datum objave</label>
                                <div class="col-12">
                                    <input type="datetime-local" class="form-control" name="publishedAt" id="publishedAt">
                                </div>
                            </div>
                        </div>
