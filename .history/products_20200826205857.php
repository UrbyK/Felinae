    ...
    <?php foreach($products as $product): 
        ...
        <div class="card products-preview col-12 col-sm-7 col-md-4 col-lg-3 col-xl-2"> 
            ...
            <div class="card-body products-preview-body">
                ...
                <?php if($product['starstAt'] <= date('Y-m-d H:i:s') && date('Y-m-d H:i:s') <= $product['endsAt']): ?>
                    <li><span class="price"><?=$product['price']?>&euro;</span></li>
                <?php else: ?>
                    <li><span class="price" style="text-decoration: line-through;"><?=$product['price']?>&euro;</span></li>
                <?php endif; ?>
                </ul>
            </div>
