                    ...
                    <form method="post" class="content">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-3">
                                ...
                                <div class="col-12">
                                    <input type="number" clas="form-control" name="weight" id="weight" step="0.01">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-12 col-form-label text-md-left" for="length">Dolžina</label>
                                <div class="col-12">
                                    <input type="number" clas="form-control" name="length" id="length" step="0.01">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-12 col-form-label text-md-left" for="width">Širina</label>
                                <div class="col-12">
                                    <input type="number" clas="form-control" name="width" id="width" step="0.01">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-12 col-form-label text-md-left" for="depth">Globina</label>
                                <div class="col-12">
                                    <input type="number" clas="form-control" name="depth" id="depth" step="0.01">
                                </div>
                            </div>
                        </div>
