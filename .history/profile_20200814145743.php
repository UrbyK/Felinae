                ...
                <div class="card-body">
                    <form method="post" class="content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="tel" class="form-control" name="phoneNumber" id="phoneNumber" value="<?=$result['phoneNumber']?>" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 offset-md-4 float-right float-sm-right">
                            <button type="button" name="update" class="btn btn-primary" id="update_btn" onclick="return confirm('Ste prepričani?');" disabled>Shrani</button>
...
<script>
    $("#update_btn").click(function(e){
        ...
        var fname = $("#fname").val();
        var lname = $("#lname").val();
        var phonenNumber = $("#phoneNumber").val();
        ...
        $.ajax({
            ...
            url: './index.php?page=includes/profile-update.inc.php',
