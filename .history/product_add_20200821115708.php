                    ...
                    <form method="post" class="content">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-3">
                                <label class="col-12 col-form-label text-md-left" for="discountPrice" min="0">Cena</label>
                                <div class="col-10">
                                    <input type="number" class="form-control" name="price" id="price" min="0" step="0.01" style="text-align:right;">€
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-12 col-form-label text-md-left" for="discount">Popust</label>
                                <div class="col-10">
                                    <input type="number" class="form-control" name="discount" id="discount" min="0" style="text-align:right;">%
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-12 col-form-label text-md-left" for="discountPrice">Cena s popustom</label>
                                <div class="col-12">
                                    <input type="number" class="form-control" name="discountPrice" id="discountPrice" min="0" step="0.01" style="text-align:right;">€
                                </div>
                            </div>
