                ...
                <div class="card-body">
                    <form method="post" action="./index.php?page=includes/register.inc" class="content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="tel" class="form-control" name="phone_number" id="phone_number" placeholder="000-000-000" pattern="[0-9]{9}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 offset-md-4">
                            <button type="submit" name="reg_btn" class="btn btn-primary" id="reg_btn">Registracija</button>
                        </div>
