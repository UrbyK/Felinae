...
<!--
                ...
                <form class="form-inline my-2 my-lg-0" method="GET" action="./index.php?page=search">
                    <input class="form-control mr-sm-2" type="search" name="search" placeholder="Iskanje..." aria-label="Search">
