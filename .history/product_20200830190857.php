        ...
        <div class="form-group shadow-textarea">
            <form method="post" action="./index.php?page=includes/review-insert.inc">
                ...
                <div class="form-group basic-textarea rounded-corners">
                    <textarea class="form-control" name="comment" id="exampleFormControlTextarea345" rows="3" placeholder="Napišite komentar..." maxlength="255" onkeyup="countChar(this)"></textarea>
