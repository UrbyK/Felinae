    ...
    <div class="row justify-content-center">
        <div class="col-sm-10">
            <div class="card user-form">
                ...
                <div class="card-body">
                    <form method="post" class="content" action="./index.php?page=includes/product-insert.inc">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 col-form-label text-md-left" for="picture">Slike</label>
                            <div class="col">
                                <input type="file" class="form-control" name= for="title" id="title" required>
                            </div>
                        </div>
