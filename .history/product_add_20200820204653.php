                ...
                <div class="card-body">
                    <form method="post" class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label class="col-12 col-form-label text-md-left" for="publishedAtDate publishedAtTime">Začetek popusta</label>
                                <div class="col-12">
                                    <input type="date" class="form-control" name="publishedAt" id="publishedAtDate">
                                    <input type="time" class="form-control" name="publishedAt" id="publishedAtTime">
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-12 col-form-label text-md-left" for="publishedAtDate publishedAtTime">Konec popusta</label>
                                <div class="col-12">
                                    <input type="date" class="form-control" name="publishedAt" id="publishedAtDate">
                                    <input type="time" class="form-control" name="publishedAt" id="publishedAtTime">
                                </div>
