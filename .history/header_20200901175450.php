            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown user-dropdown">
                        <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user"></i> Uporabnik</a>
                        <div class="dropdown-menu">
                            
                            <?php if(empty($_SESSION['loggedin'])): ?>
                                <a class="dropdown-item" href="./index.php?page=login" title="Login"><i class="fas fa-sign-in-alt"></i></i> Prijava</a>
                                <a class="dropdown-item" href="./index.php?page=register" title="Register">Registracija</a>
                            <?php endif; ?>

                            <?php if(isset($_SESSION['loggedin']) && !empty($_SESSION['loggedin'])): ?>
                                <a class="dropdown-item" href="./logout.php">Oddjava</a>
