                ...
                <div class="card user-form">
                    ...
                    <div class="card-body">
                        <form method="post" class="content" action="./index.php?page=src/inc/category-insert.inc" enctype="multipart/form-data">
                            ...
                            <div class="form-row" id="form-container">
...
<script>
    $(document).ready(function() {
        ...
        div.innerHTLM = document.getElementById('form-input-row').innerHTML;
        ...
        $(add_button).click(function(e) {
            ...
            if(x < max_fields) {
                x++;
                document.getElementById('form-container').appendChild(item);
            } else {
