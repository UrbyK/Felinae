...
<div class="container">
    <div class="row">
        <div class="col-12pagnation">
            <?php if($current_page>=2):?>
                <a href="./index.php?page=products&p="<?=$current_page-1?>> Nazaj </a>

                <?php for($i=1; $i<=$total_pages; $i++):
                    if($i == $current_page): ?>
                        <a class="active" href="./index.php?page=products&p=<?=$i?>"><?=$i?></a>
                    <?php else: ?>
            ...
            if($current_page < $total_pages): ?>
                <a href="./index.php?page=products&p=<?=$current_page+1?>"> Naprej </a>
            <?php endif; ?>
