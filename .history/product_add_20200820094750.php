                    ...
                    <form method="post" class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                <label class="col-sm-6 col-form-label text-md-left" for="sku">Skladišče</label>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="sku" id="sku">
                                </div>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-sm-6 col-form-label text-md-left" for="quantity">Količina</label>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="quantity" id="quantity">
                                    <span id="message">Če ni vnosa je količina ista kot tista v skladišču.</span>
                                </div>
                            </div>
                        </div>
