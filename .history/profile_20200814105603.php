                ...
                <div class="card-body">
                    <form method="post" class="content">
                        ...
                        <div class="col-md-6 offset-md-4 float-right float-sm-right">
                            <button type="submit" name="update" class="btn btn-primary" id="update_btn" disabled>Shrani</button>
...
<script>
    $(document).ready(function(){
        ...
        $("button[name=edit]").on("click", function(){
            $("input, button[name=update]").removeAttr("disabled");
        })
        $("button[name=update]").on("click", function(){
            $(".content input[type=text], .content button[name=update]").prop("disabled", true);
        })
    })
</script>
