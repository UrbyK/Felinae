            ...
            <div class="card user-form">
                ...
                <div class="card-body">
                    <form method="post" class="content">
                        <h2 class="segmant-name">Opis izdelkas</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-2">
                                <label class="col-md-6 col-form-label text-md-left" for="sku">Skladišče</label>
                                <div class="col-md-6">
                                    <input type="number" class="form-control" name="sku" id="sku">
                                </div>
                            </div>
                            <div class="form-group col-sm-2">
                                <label class="col-md-6 col-form-label text-md-left" for="quantity">Količina</label>
                                <div class="col-md-6">
