                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span clas="countdown">dsfdasf</span>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
                                <div class="form-group row">
...
<script>
    ...
    function () {
        ...
        $(this).closest('div').nextAll(':has(.countdown):first').find('.countdown').text('Na voljo je še: ' + (remainingChars<=0?0:remainingChars) + ' znakov.');
    });
});
</script>
