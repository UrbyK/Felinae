...
<div class="container">
    ...
    <?php foreach($products as $product): ?>
        ...
        <div class="card col-12 col-sm-7 col-md-4 col-lg-3 col-xl-2">
            ...
            <div class="card-body">
                <ul>
                    <li><a href="./index.php?page=product&id=<?=$product['id']?>"></li>
                    <li><span class="price"><?=$product['price']?>&euro</span></li>
                </ul>
            </div>

            <div class="card-footer">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vel nisl porttitor leo efficitur fermentum at et nunc. Proin vitae dolor sem. Aenean nisl massa, pretium vel tristique sed, vestibulum ut magna. Sed elit nibh, tincidunt quis laoreet donec. </p>
            </div>
