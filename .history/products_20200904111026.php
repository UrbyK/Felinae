            ...
            <nav aria-label="navigation">
                <ul class="pagination">
                    <?php if($current_page>=2):?>
                        <li class="page-item"><a class="page-link" href="./index.php?page=products&p=<?=$current_page-1?>"> Nazaj </a></li>

                    <?php endif;
                    for($i=1; $i<=$total_pages; $i++):
                        if($i == $current_page): ?>
                            <li class="page-item active"><a class="page-link" href="./index.php?page=products&p=<?=$i?>"><?=$i?></a></li>
                        <?php else: ?>
                            <li class="page-item"><a class="page-link" href="./index.php?page=products&p=<?=$i?>"><?=$i?></a></li>
                        <?php endif; 
                    endfor; 
                     
                    if($current_page < $total_pages): ?>
                        <li class="page-item"><a class="page-link" href="./index.php?page=products&p=<?=$current_page+1?>"> Naprej </a></li>
                    <?php endif; ?>
                </ul><!-- pagination -->
            </nav><!-- navigation -->
