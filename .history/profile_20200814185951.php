                ...
                <div class="card-body">
                    <form method="post" class="content">
                        ...
                        <div class="col-md-6 offset-md-4 float-right float-sm-right">
                            <button type="button" name="update" class="btn btn-primary" id="update_btn" onclick="return confirm('Želite posodobiti podatke?');" disabled>Shrani</button>
