                    ...
                    <form method="post" class="content">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-3">
                                <label class="col-10 col-form-label text-md-left" for="weight">Teža</label>
                                <div class="col-10">
                                    <input type="number" clas="form-control" name="weight" id="weight">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-10 col-form-label text-md-left" for="length">Dolžina</label>
                                <div class="col-10">
                                    <input type="number" clas="form-control" name="length" id="length">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-10 col-form-label text-md-left" for="width">Širina</label>
                                <div class="col-10">
                                    <input type="number" clas="form-control" name="width" id="width">
                                </div>
                            </div>
                            <div class="form-group col-sm-3">
                                <label class="col-10 col-form-label text-md-left" for="depth">Globina</label>
                                <div class="col-10">
