                        ...
                        <form method="post" action="./index.php?page=src/inc/register.inc" class="content my-form">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="username" id="username" placeholder="Uporabniško ime" pattern=".{4,}" limit="60" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="email" class="form-control" name="email" id="email" placeholder="Elektronska pošta" limit="150" required>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right" for="password">Geslo<span class="required">*</span></label>
                                    <div class="col-md-6">
                                        <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^A-Za-z0-9]).{8,}" class="form-control" name="password" id="password" placeholder="Geslo" data-limit=255  autocomplete="off" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="Potrdite geslo" autocomplete="off" required>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="fname" id="fname" placeholder="Ime" limit="90" required>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right" for="lname">Priimek<span class="required">*</span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="lname" id="lname" placeholder="Priimek" limit="90" required>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="address" id="address" placeholder="Velika ulica, 4" limit="100" required>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
                                <div class="form-group row">
                                    <lable class="col-md-4 col-form-label text-md-right" for="postalCode">Poštna številka<span class="required">*</span></lable>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="postalCode" id="postalCode" placeholder="1000" limit="13" required>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
                                <div class="form-group row">
                                    <lable class="col-md-4 col-form-label text-md-right" for="city">Mesto<span class="required">*</span></lable>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="city" id="city" placeholder="Ljubljana" limit="60" required>
                                    </div><!-- col-md-6 -->
                                </div><!-- form-group row -->
