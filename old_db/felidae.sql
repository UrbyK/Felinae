...
CREATE TABLE IF NOT EXISTS `felinae`.`product` (
  ...
  `sku` VARCHAR(100) NOT NULL COMMENT 'The Stock Keeping Unit to track the prodact inventory.',
...
CREATE TABLE IF NOT EXISTS `felinae`.`account` (
  ...
  `admin` INT NOT NULL DEFAULT 0 COMMENT 'The field that defines if a user is a Admin.',
...
CREATE TABLE IF NOT EXISTS `felinae`.`order_item` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'The ID field.',
  `quantity` VARCHAR(45) NOT NULL COMMENT 'The field that contains the quantity of an item.',
...
CREATE TABLE IF NOT EXISTS `felinae`.`transaction` (
  ...
  `code` VARCHAR(100) NOT NULL COMMENT 'The paymant id provided by the paymant gateway.',
